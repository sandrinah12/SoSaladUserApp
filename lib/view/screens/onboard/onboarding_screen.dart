        ...
        builder: (onBoardingController) => onBoardingController.onBoardingList.length > 0 ? SafeArea(
          child: Center(child: SizedBox(width: Dimensions.WEB_MAX_WIDTH, child: Column(children: [
              ...
              itemBuilder: (context, index) {
                return Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Text(
                    ...
                    style: museoMedium.copyWith(fontSize: context.height*0.022),
                  ...
                  Padding(
                    ...
                    child: Text(
                      ...
                      style: museoRegular.copyWith(fontSize: context.height*0.015, color: Theme.of(context).disabledColor),
                      textAlign: TextAlign.center,
                    ),
                  ),
            ...
            Padding(
              ...
              child: Row(children: [
                onBoardingController.selectedIndex == 1 ? SizedBox() : Expanded(
                  child: CustomButton(
                    transparent: true,
                    onPressed: () {
                ...
                Expanded(
                  child: CustomButton(
                    buttonText: onBoardingController.selectedIndex != 1 ? 'next'.tr : 'get_started'.tr,
                    onPressed: () {
                      if(onBoardingController.selectedIndex != 1) {
