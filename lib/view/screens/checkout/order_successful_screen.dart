...
import 'package:sosalad/view/screens/checkout/widget/payment_failed_dialog.dart';
      ...
      body: GetBuilder<OrderController>(builder: (orderController) {
        ...
        return orderController.trackModel != null ? Center(child: SizedBox(width: Dimensions.WEB_MAX_WIDTH, child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          (success && Get.find<SplashController>().configModel.loyaltyPointStatus == 1 && total.floor() > 0 )  ? Column(children: [
            ...
            Text('congratulations'.tr , style: museoMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
            SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
            ...
            Padding(
              ...
              child: Text(
                ...
                style: museoRegular.copyWith(fontSize: Dimensions.fontSizeLarge,color: Theme.of(context).disabledColor),
                textAlign: TextAlign.center,
              ),
            ),
