...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  void initState() {
    super.initState();
    // Lien vers le webview : payment method
    selectedUrl = '${AppConstants.BASE_URL}/payment-mobile?customer_id=${widget.orderModel.userId}&order_id=${widget.orderModel.id}&method_payment_id=${widget.orderModel.method_payment_id}';
    print(selectedUrl);
