...
import 'package:sosalad/view/screens/search/widget/filter_widget.dart';
import 'package:sosalad/view/screens/search/widget/search_field.dart';
import 'package:sosalad/view/screens/search/widget/search_result_widget.dart';
              ...
              Expanded(child: searchController.isSearchMode ? SingleChildScrollView(
                ...
                child: Center(child: SizedBox(width: Dimensions.WEB_MAX_WIDTH, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  searchController.historyList.length > 0 ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    Text('history'.tr, style: museoMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                    ...
                    InkWell(
                      ...
                      child: Padding(
                        ...
                        child: Text('clear_all'.tr, style: museoRegular.copyWith(
                  ...
                  (_isLoggedIn && searchController.suggestedFoodList != null) ? Text(
                    'suggestions'.tr, style: museoMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
                  ) : SizedBox(),
