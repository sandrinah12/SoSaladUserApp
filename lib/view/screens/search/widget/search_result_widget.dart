...
import 'package:sosalad/view/screens/search/widget/item_view.dart';
      ...
      GetBuilder<SearchController>(builder: (searchController) {
        ...
        return _isNull ? SizedBox() : Center(child: SizedBox(width: Dimensions.WEB_MAX_WIDTH, child: Padding(
          ...
          child: Row(children: [
            Text(
              _length.toString(),
              style: museoBold.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeSmall),
            ),
