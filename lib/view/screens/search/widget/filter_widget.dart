...
import 'package:sosalad/view/screens/search/widget/custom_check_box.dart';
          ...
          return SingleChildScrollView(
            child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                Text('filter'.tr, style: museoMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                CustomButton(
                  onPressed: () {
              ...
              Text('sort_by'.tr, style: museoMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
              ...
              Text('filter_by'.tr, style: museoMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
              SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
              ...
              isRestaurant ? SizedBox() : Column(children: [
                Text('price'.tr, style: museoMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                RangeSlider(
              ...
              Text('rating'.tr, style: museoMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
              Container(
