...
import 'package:sosalad/view/base/custom_dialog.dart';
          ...
          child: GetBuilder<AuthController>(builder: (authController) {
            return Column(children: [
              ...
              Get.find<SplashController>().configModel.demo ? Text(
                'for_demo_purpose'.tr, style: museoRegular,
              ) : RichText(text: TextSpan(children: [
                TextSpan(text: 'enter_the_verification_sent_to'.tr, style: museoRegular.copyWith(color: Theme.of(context).disabledColor)),
                TextSpan(text: ' $_number', style: museoMedium.copyWith(color: Theme.of(context).textTheme.bodyLarge.color)),
              ])),
                        ...
                        showAnimatedDialog(context, Center(
                          child: Container(
                            ...
                            child: Column(mainAxisSize: MainAxisSize.min, children: [
                              ...
                              Text('verified'.tr, style: museoBold.copyWith(
