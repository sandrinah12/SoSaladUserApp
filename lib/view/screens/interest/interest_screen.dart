          ...
          return categoryController.categoryList != null ? categoryController.categoryList.length > 0 ? Center(
            child: Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text('choose_your_interests'.tr, style: museoMedium.copyWith(fontSize: 22)),
                SizedBox(height: Dimensions.PADDING_SIZE_SMALL),

                Text('get_personalized_recommendations'.tr, style: museoRegular.copyWith(color: Theme.of(context).disabledColor)),
                SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
