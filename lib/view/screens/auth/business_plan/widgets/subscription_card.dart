    ...
    return Container(
      child: Column(children: [
        ...
        Text(
          ...
          style: museoBold.copyWith(fontSize: 35, color: color),
        ),

        Text('${'${package.validity} ' 'days'.tr}', style: museoBold.copyWith(fontSize: Dimensions.fontSizeSmall)),
        SizedBox(height: Dimensions.PADDING_SIZE_DEFAULT),
