...
import 'package:sosalad/data/model/response/package_model.dart';
import 'package:sosalad/helper/color_coverter.dart';
...
import 'package:sosalad/view/screens/auth/business_plan/widgets/subscription_card.dart';
import 'package:sosalad/view/screens/auth/business_plan/widgets/success_widget.dart';
                      ...
                      child: Center(
                        child: Column(children: [
                          ...
                          authController.businessPlanStatus != 'payment' ? Column(children: [
                            ...
                            Center(child: Text('choose_your_business_plan'.tr, style: museoBold.copyWith(fontSize: Dimensions.fontSizeDefault))),
                            ...
                            authController.businessIndex == 0 ? Padding(
                              ...
                              child: Text(
                                ...
                                style: museoRegular, textAlign: TextAlign.start, textScaleFactor: 1.1,
                              ),
                            ) : Container(
                              child: Column(children: [
                                Padding(
                                  ...
                                  child: Text(
                                    ...
                                    style: museoRegular, textAlign: TextAlign.start,
                                  ),
                                ),
                        ...
                        child: InkWell(
                          ...
                          child: Padding(
                            ...
                            child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                              ...
                              Text("back".tr, style: museoRegular.copyWith(fontSize: Dimensions.fontSizeLarge),),
                            ]),
                          ),
                        ),
                      ) : SizedBox(),
        ...
        return Stack( clipBehavior: Clip.none, children: [
            InkWell(
              ...
              child: Container(
                ...
                child: Text(title, style: museoBold.copyWith(color: authController.paymentIndex == index ? Theme.of(context).primaryColor : Theme.of(context).textTheme.bodyLarge.color)),
              ),
            ),
    ...
    return InkWell(
      ...
      child: Stack(clipBehavior: Clip.none, children: [
        ...
        Container(
          ...
          child: Center(child: Text(title, style: museoMedium.copyWith(color: authController.businessIndex == index ? Theme.of(context).primaryColor : Theme.of(context).textTheme.bodyLarge.color, fontSize: Dimensions.fontSizeDefault))),
        ),
