...
import 'package:sosalad/view/screens/home/widget/category_pop_up.dart';
...
class CategoryView1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<CategoryController>(builder: (categoryController) {
      //List<CategoryModel> _categoryList = categoryController.categoryList;
                              ...
                              child: Stack(children: [
                                ...
                                Positioned(bottom: 0, left: 0, right: 0, child: Container(
                                  ...
                                  child: Text(
                                    ...
                                    style: museoMedium.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Colors.white),
                                  ),
                                )),
                              ]),
                            ),
