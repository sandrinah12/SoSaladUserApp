                          ...
                          Positioned(
                            ...
                            child: Container(
                              ...
                              child: Row(children: [
                                ...
                                Text(_productList[index].avgRating.toStringAsFixed(1), style: museoRegular),
                              ]),
                            ),
                          ),
                        ]),
                                ...
                                Row(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.end, children: [
                                  ...
                                  Text(
                                    PriceConverter.convertPrice(
                                      _productList[index].price, discount: productController.getDiscount(_productList[index]),
