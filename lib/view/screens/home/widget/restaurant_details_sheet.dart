            ...
            child: Container(
              ...
              child: Column(children: [
                ...
                Row(children: [
                  ...
                  Expanded(child: Text(restaurant.name, maxLines: 1, style: museoBold.copyWith(fontSize: Dimensions.fontSizeDefault))),
                  ...
                  Text('(${restaurant.ratingCount})', style: museoMedium.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).disabledColor)),
                ]),
                SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                ...
                Row(children: [
                  ...
                  )/1000).toStringAsFixed(1)} ${'km'.tr}', style: museoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                  ...
                  restaurant.freeDelivery ?  Row(children: [
                    ...
                    Text('free'.tr, style: museoMedium.copyWith(fontSize: Dimensions.fontSizeDefault)),
                  ]) : SizedBox(),
