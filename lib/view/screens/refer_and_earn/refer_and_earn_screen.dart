...
import 'package:sosalad/helper/link_converter.dart';
...
class _ReferAndEarnScreenState extends State<ReferAndEarnScreen> {
  ...
  Widget build(BuildContext context) {
    String initialLink = 'sosalad://sosalad.com/category-product?id=5&name=QnVyZ2Vy';
        ...
        child: SizedBox(
          ...
          child: _isLoggedIn ? Padding(
            ...
            child: Column( children: [
              ...
              Text('earn_money_on_every_referral'.tr, style: museoRegular.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeSmall)),
              ...
              Text(
                  ...
                  style: museoBold.copyWith(fontSize: Dimensions.fontSizeDefault),
              ),
              SizedBox(height: 40),
              ...
              Center(
                child: Row(mainAxisSize: MainAxisSize.min, children: [
                  Column(children: [
                    ...
                    SizedBox(width: 120,
                        child: Text('refer_your_code_to_your_friend'.tr , style: museoRegular.copyWith(fontSize: Dimensions.fontSizeSmall), textAlign: TextAlign.center),
                    ),
                  ]),
                  ...
                  Column(children: [
                    ...
                    SizedBox(width: 120, child: Text(
                        'get'.tr + ' ${PriceConverter.convertPrice(Get.find<SplashController>().configModel != null ? Get.find<SplashController>().configModel.refEarningExchangeRate.toDouble() : 0.0)} ' +
                            'on_joining'.tr , style: museoRegular.copyWith(fontSize: Dimensions.fontSizeSmall), textAlign: TextAlign.center),
                    ),
                  ]),
                ]),
              ),
              ...
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text('your_referral_code'.tr, style: museoRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeDefault)),
                    ...
                    child: (Get.find<UserController>().userInfoModel != null) ? Row(children: [
                      Expanded(
                          child: Text('${Get.find<UserController>().userInfoModel != null ? Get.find<UserController>().userInfoModel.refCode : ''}',
                              style: museoBlack.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeExtraLarge),
                          ),
                      ),
                      InkWell(
                        onTap: () {
                          ...
                          child: Text('tap_to_copy'.tr, style: museoMedium)),
