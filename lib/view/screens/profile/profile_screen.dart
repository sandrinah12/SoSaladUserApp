...
import 'package:sosalad/view/screens/profile/widget/profile_bg_widget.dart';
import 'package:sosalad/view/screens/profile/widget/profile_button.dart';
import 'package:sosalad/view/screens/profile/widget/profile_card.dart';
          ...
          mainWidget: SingleChildScrollView(physics: BouncingScrollPhysics(), child: Center(child: Container(
            ...
            child: Column(children: [
              ...
              Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                Text('${'version'.tr}:', style: museoRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall)),
                SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                Text(AppConstants.APP_VERSION.toString(), style: museoMedium.copyWith(fontSize: Dimensions.fontSizeExtraSmall)),
              ]),
