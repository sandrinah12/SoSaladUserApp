...
import 'package:sosalad/view/screens/order/widget/order_shimmer.dart';
                            ...
                            Row(children: [
                              ...
                              Expanded(
                                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                  Row(
                                      children: [
                                    Text('${'order_id'.tr}:', style: museoRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                                    SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                                    Expanded(child: Text('#${orderList[index].id}', style: museoMedium.copyWith(fontSize: Dimensions.fontSizeSmall))),
                                  ]),
                                  SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                                  Text(
                                    DateConverter.dateTimeStringToDateTime(orderList[index].createdAt),
                                    style: museoRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall),
                                  ),
                                ]),
                              ),
                              SizedBox(width: Dimensions.PADDING_SIZE_SMALL),
                              ...
                              Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                                Container(
                                  ...
                                  child: Text(orderList[index].orderStatus.tr, style: museoMedium.copyWith(
                                ...
                                isRunning ? InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(children: [
                                      ...
                                      SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                                      Text('track_order'.tr, style: museoMedium.copyWith(
                                        fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).primaryColor,
                                      )),
                                    ]),
                                  ),
                                  ...
                                  style: museoRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall),
                                ),
                              ]),
