...
import 'package:sosalad/view/base/address_details.dart';
import 'package:sosalad/view/base/custom_divider.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: (!_takeAway && track.deliveryMan == null) ? Padding(
        padding: EdgeInsets.all(Dimensions.PADDING_SIZE_SMALL),
        child: Text(
          'delivery_man_not_assigned'.tr, style: museoMedium, textAlign: TextAlign.center,
        ),
      ) : Column(children: [

        Text('trip_route'.tr, style: museoMedium),
        ...
        Row(children: [
          ...
          Expanded(
              flex: 5,
              child: _takeAway ? Text(track.restaurant != null ? track.restaurant.address : '', style: museoRegular.copyWith(fontSize: Dimensions.fontSizeSmall),
