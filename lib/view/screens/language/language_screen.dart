...
import 'package:sosalad/view/screens/language/widget/language_widget.dart';
                ...
                child: SingleChildScrollView(
                  ...
                  child: Center(child: SizedBox(
                    ...
                    child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      //Center(child: Text(AppConstants.APP_NAME, style: museoMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE))),
                      SizedBox(height: 30),

                      Padding(
                        padding: EdgeInsets.symmetric(horizontal: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                        child: Text('select_language'.tr, style: museoMedium),
                      ),
                      ...
                      Text('you_can_change_language'.tr, style: museoRegular.copyWith(
