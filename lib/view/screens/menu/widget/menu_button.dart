...
import 'package:sosalad/data/model/response/menu_model.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      child: Column(children: [
        ...
        Text(menu.title, style: museoMedium.copyWith(fontSize: Dimensions.fontSizeSmall), textAlign: TextAlign.center),
