...
import 'package:sosalad/data/model/response/wallet_model.dart';
        ...
        children: [
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              fromWallet ? Text(data[index].transactionType == 'order_place'
                ...
                style: museoMedium.copyWith(fontSize: Dimensions.fontSizeDefault), maxLines: 1, overflow: TextOverflow.ellipsis,
              ) : Row(children: [
                ...
                Text('points'.tr, style: museoRegular.copyWith(fontSize: Dimensions.fontSizeSmall,color: Theme.of(context).disabledColor),
                )]),
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
              Text(DateConverter.dateToDateAndTimeAm(data[index].createdAt),style: museoRegular.copyWith(fontSize: Dimensions.fontSizeSmall,color: Theme.of(context).disabledColor),
                  maxLines: 1, overflow: TextOverflow.ellipsis),
              SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
              ...
              Text( fromWallet ? data[index].transactionType == 'order_place' ? 'debit' : 'credit' : data[index].transactionType == 'point_to_wallet' ? 'debit' : 'credit',
                  style: museoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: fromWallet ? data[index].transactionType == 'order_place'
