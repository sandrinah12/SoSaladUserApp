                  ...
                  children: [
                    ...
                    Row(children: [
                        ...
                        children: [
                          ...
                          isAvailable ? SizedBox() : Positioned(
                            ...
                            child: Container(
                              ...
                              child: Text('not_available_now_break'.tr, textAlign: TextAlign.center, style: museoRegular.copyWith(
                      ...
                      Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                        ...
                        Row(children: [
                          ...
                          Text(cart.quantity.toString(), style: museoMedium.copyWith(fontSize: Dimensions.fontSizeExtraLarge)),
                          QuantityButton(
                    ...
                    (_variationText != '' && cart.product.variations != null && cart.product.variations.length > 0) ? Padding(
                      ...
                      child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Flexible(child: Text(_variationText, style: museoMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                        ),
                      ]),
                    ) : SizedBox(),
