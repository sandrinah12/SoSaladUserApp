...
import 'package:sosalad/data/model/response/message_model.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return (message != null && _isReply) ? Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text('${user.fName} ${user.lName}' ?? '', style: museoRegular.copyWith(fontSize: Dimensions.fontSizeLarge)),
        ...
        Text(
          ...
          style: museoRegular.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.fontSizeSmall),
        ),
      ]),
    ) : Container(
