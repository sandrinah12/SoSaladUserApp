...
import 'package:sosalad/view/base/quantity_button.dart';
            ...
            Padding(
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Expanded(
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text(
                        widget.product.name, style: museoMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
                      ...
                      Text(
                        ...
                        style: museoMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
                      ),

                      Row(children: [
                        _price > priceWithDiscount ? Text(
                          '${PriceConverter.convertPrice(_price)}',
                          style: museoMedium.copyWith(color: Theme.of(context).disabledColor, decoration: TextDecoration.lineThrough),
                        ) : SizedBox(),
                  ...
                  Column(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    Get.find<SplashController>().configModel.toggleVegNonVeg ? Container(
                      ...
                      child: Text(
                        ...
                        style: museoRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Colors.white),
                      ),
                    ) : SizedBox(),
                ...
                (widget.product.description != null && widget.product.description.isNotEmpty) ? Column(
                  ...
                  children: [
                    Text('description'.tr, style: museoMedium),
                    SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                    Text(widget.product.description, style: museoRegular),
                    SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
                  ],
                ) : SizedBox(),
                  ...
                  itemBuilder: (context, index) {
                    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Row(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.center, children: [
                        Text(widget.product.variations[index].name, style: museoMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                            ...
                            child: Row(children: [
                              ...
                              Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                                ...
                                Text(
                                  ...
                                  style: productController.selectedVariations[index][i] ? museoMedium : museoRegular,
                                ),
                              ...
                              Text(
                                ...
                                maxLines: 1, overflow: TextOverflow.ellipsis,
                                style: productController.selectedVariations[index][i] ? museoMedium.copyWith(fontSize: Dimensions.fontSizeExtraSmall)
                                    : museoRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor),
                              ),
                ...
                // Quantity
                Row(children: [
                  Text('quantity'.tr, style: museoMedium),
                  ...
                  Row(children: [
                    ...
                    Text(productController.quantity.toString(), style: museoMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                    QuantityButton(
                ...
                widget.product.addOns.length > 0 ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text('addons'.tr, style: museoMedium),
                  SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                  GridView.builder(
                ...
                Row(children: [
                  Text('${'total_amount'.tr}:', style: museoMedium),
                  SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                  Text(PriceConverter.convertPrice(priceWithAddonsVariation), style: museoBold.copyWith(color: Theme.of(context).primaryColor)),
                  SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                  (priceWithAddonsVariationWithoutDiscount > priceWithAddonsVariation) ? Text(
                    ...
                    style: museoMedium.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall, decoration: TextDecoration.lineThrough),
                  ) : SizedBox(),
                ]),
                SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
                ...
                _isAvailable ? SizedBox() : Container(
                  ...
                  child: Column(children: [
                    Text('not_available_now'.tr, style: museoMedium.copyWith(
                    ...
                    onPressed: () async {
                      ...
                      if(widget.isCampaign) {
                        Get.toNamed(RouteHelper.getCheckoutRoute('campaign',''), arguments: CheckoutScreen(
                          fromCart: false, cartList: [_cartModel],delivery_note: '',
                        ));
                      }else {
  ...
  void _showCartSnackBar() {
    ScaffoldMessenger.of(Get.context).showSnackBar(SnackBar(
      ...
      content: Text(
        ...
        style: museoMedium.copyWith(color: Colors.white),
      ),
    ));
    ...
    //     child: Text('view_cart'.tr, style: museoMedium.copyWith(color: Theme.of(context).cardColor)),
    //   ),
