      ...
      child: PointerInterceptor(
        child: SizedBox(width: 500, child: Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Padding(
              padding: EdgeInsets.all(Dimensions.PADDING_SIZE_LARGE),
              child: Text(description, style: museoMedium.copyWith(fontSize: Dimensions.fontSizeLarge), textAlign: TextAlign.center),
            ),
                  ...
                  return (orderController.isLoading || userController.isLoading) ? Center(child: CircularProgressIndicator()) : Row(children: [
                    Expanded(child: TextButton(
                      ...
                      child: Text(
                        ...
                        style: museoBold.copyWith(color: Theme.of(context).textTheme.bodyLarge.color),
                      ),
                    )),
