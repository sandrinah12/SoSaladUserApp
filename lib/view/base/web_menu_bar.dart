      ...
      child: Row(children: [
        ...
        _showJoin ? PopupMenuButton<dynamic>(
          ...
          child: Container(
            ...
            child: Row(children: [
              Text('join_us'.tr, style: museoMedium.copyWith(color: Colors.white)),
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Row(children: [
            ...
            return cartController.cartList.length > 0 ? Positioned(
              ...
              child: Container(
                ...
                child: Text(
                  ...
                  style: museoRegular.copyWith(fontSize: 12, color: Theme.of(context).cardColor),
                ),
              ),
            ) : SizedBox();
          }) : SizedBox(),
        ...
        Text(title, style: museoRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
      ]),
    );
  }
}
