...
class _CustomTextFieldState extends State<CustomTextField> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        widget.showTitle ? Text(widget.hintText, style: museoRegular.copyWith(fontSize: Dimensions.fontSizeSmall)) : SizedBox(),
        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            hintStyle: museoRegular.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).hintColor),
            filled: true,
