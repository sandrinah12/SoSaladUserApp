...
import 'package:sosalad/data/model/body/social_log_in_body.dart';
...
import 'package:sosalad/view/base/image_viewer_screen.dart';
import 'package:sosalad/view/base/not_found.dart';
import 'package:sosalad/view/screens/address/add_address_screen.dart';
import 'package:sosalad/view/screens/address/address_screen.dart';
import 'package:sosalad/view/screens/auth/business_plan/business_plan.dart';
import 'package:sosalad/view/screens/auth/delivery_man_registration_screen.dart';
import 'package:sosalad/view/screens/auth/restaurant_registration_screen.dart';
import 'package:sosalad/view/screens/auth/sign_in_screen.dart';
import 'package:sosalad/view/screens/auth/sign_up_screen.dart';
import 'package:sosalad/view/screens/cart/cart_screen.dart';
import 'package:sosalad/view/screens/category/category_product_screen.dart';
import 'package:sosalad/view/screens/category/category_screen.dart';
import 'package:sosalad/view/screens/chat/chat_screen.dart';
import 'package:sosalad/view/screens/chat/conversation_screen.dart';
import 'package:sosalad/view/screens/checkout/checkout_screen.dart';
import 'package:sosalad/view/screens/checkout/order_successful_screen.dart';
import 'package:sosalad/view/screens/checkout/payment_screen.dart';
import 'package:sosalad/view/screens/coupon/coupon_screen.dart';
import 'package:sosalad/view/screens/cuisine/cuisine_restaurant_screen.dart';
import 'package:sosalad/view/screens/cuisine/cuisine_screen.dart';
import 'package:sosalad/view/screens/dashboard/dashboard_screen.dart';
import 'package:sosalad/view/screens/food/item_campaign_screen.dart';
import 'package:sosalad/view/screens/food/popular_food_screen.dart';
import 'package:sosalad/view/screens/forget/forget_pass_screen.dart';
import 'package:sosalad/view/screens/forget/new_pass_screen.dart';
import 'package:sosalad/view/screens/forget/verification_screen.dart';
import 'package:sosalad/view/screens/home/map_view_screen.dart';
import 'package:sosalad/view/screens/html/html_viewer_screen.dart';
import 'package:sosalad/view/screens/interest/interest_screen.dart';
import 'package:sosalad/view/screens/language/language_screen.dart';
import 'package:sosalad/view/screens/location/access_location_screen.dart';
import 'package:sosalad/view/screens/location/map_screen.dart';
import 'package:sosalad/view/screens/location/pick_map_screen.dart';
import 'package:sosalad/view/screens/notification/notification_screen.dart';
import 'package:sosalad/view/screens/onboard/onboarding_screen.dart';
import 'package:sosalad/view/screens/order/order_details_screen.dart';
import 'package:sosalad/view/screens/order/order_screen.dart';
import 'package:sosalad/view/screens/order/order_tracking_screen.dart';
import 'package:sosalad/view/screens/order/refund_request_screen.dart';
import 'package:sosalad/view/screens/profile/profile_screen.dart';
import 'package:sosalad/view/screens/profile/update_profile_screen.dart';
import 'package:sosalad/view/screens/refer_and_earn/refer_and_earn_screen.dart';
import 'package:sosalad/view/screens/restaurant/all_restaurant_screen.dart';
import 'package:sosalad/view/screens/restaurant/campaign_screen.dart';
import 'package:sosalad/view/screens/restaurant/restaurant_product_search_screen.dart';
import 'package:sosalad/view/screens/restaurant/restaurant_screen.dart';
import 'package:sosalad/view/screens/restaurant/review_screen.dart';
import 'package:sosalad/view/screens/search/search_screen.dart';
import 'package:sosalad/view/screens/splash/splash_screen.dart';
import 'package:sosalad/view/screens/support/support_screen.dart';
import 'package:sosalad/view/screens/update/update_screen.dart';
import 'package:sosalad/view/screens/wallet/wallet_screen.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

import '../view/screens/salad/all_salad_screen.dart';
...
class RouteHelper {
  ...
  static const String allSalad = '/all-salad';
  ...
  static String getPaymentRoute(String id, int user, double amount, double maximumCodOrderAmount, String method_payment_id) => '$payment?id=$id&user=$user&amount=$amount&max-cod-amount=$maximumCodOrderAmount&method_payment_id=$method_payment_id';
  static String getCheckoutRoute(String page,String note) => '$checkout?page=$page&note=$note';
  ...
  static String getAllSalad() => '$allSalad';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: payment, page: () => getRoute(PaymentScreen(orderModel: OrderModel(
        id: int.parse(Get.parameters['id']), userId: int.parse(Get.parameters['user']), orderAmount: double.parse( Get.parameters['amount']), method_payment_id: Get.parameters['method_payment_id']
    ...
    GetPage(name: checkout, page: () {
      ...
      String delivery_note = Get.parameters['note'];
      return getRoute(_checkoutScreen != null ? _checkoutScreen : !_fromCart ? NotFound() : CheckoutScreen(
        cartList: null, fromCart: Get.parameters['page'] == 'cart',delivery_note: delivery_note
      ));
    }),
